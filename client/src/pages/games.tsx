...
export default function GamesPage() {
  ...
  const enhancedGames = useMemo(() => {
    return games.map(game => ({
      ...
      tags: game.name === 'Minecraft' ? ['Building', 'Creative', 'Multiplayer'] :
            ...
            ['Multiplayer', 'Action'],
      difficulty: game.name === 'Minecraft' ? 'Easy' as const :
                  game.name === 'CS2' ? 'Hard' as const :
                  game.name === 'Rust' ? 'Hard' as const :
                  'Medium' as const,
      minPlayers: 1,
  ...
  const filteredAndSortedGames = useMemo(() => {
    ...
    return filtered;
  }, [enhancedGames, searchTerm, selectedCategory, selectedDifficulty, sortBy]);
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-gaming-black/80 text-gaming-green font-bold">
                        ${game.basePrice}/mo
                      </Badge>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge className={getDifficultyColor(game.difficulty || 'Medium')}>
                        {game.difficulty}
                      </Badge>
                    </div>
